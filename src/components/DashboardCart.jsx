    ...
    <div className="md:flex items-center gap-6 border bg-white rounded-xl p-6 mb-6">
      ...
      <div className="space-y-3 flex-grow">
        <div className="flex items-center justify-between">
          ...
          <div className="text-xl text-red-600 font-semibold border border-red-600 p-1 rounded-full cursor-pointer">        <RxCross2 onClick={()=> {handleRemove(gadget); handleDecreasePrice(price)}}></RxCross2></div>
        </div>
